...
for item in [42480,61499,80615,90282,90283,90284,90285,90286,90287,90288,90289,90290,90291,99492,2002844,2021724,2040411,2059450,2059559,2059560,2076838,2095499,1011997,1030977,1049973,1066731,1085677,1104424]:
    fetch_and_append_item(item, OUTPUT_FILE, 0)
